...
from utils import ensures_dir, init_pandas
...
@click.option(
    "--sample_rate", default=SAMPLE_RATE, show_default=True, type=int
)
...
@click.option(
    "--counts_per_speaker", default="600,100", show_default=True, type=str
)  # train,test
...
@click.option("--working_dir", required=True, type=Ct.input_dir())
@click.option(
    "--pre_training_phase/--no_pre_training_phase",
    default=False,
    show_default=True,
)
